					...
					<div class="row">
						<div class="col-md-4 col-sm-4">
							<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default",
									array(
										...
										"PATH" => SITE_DIR."include/company_inf.php",
										"AREA_FILE_SHOW" => "file",
										"AREA_FILE_SUFFIX" => "",
						...
						<div class="col-md-4 col-sm-4">
							<div class="info contacts_block_footer">
								...
								<?$APPLICATION->IncludeFile(SITE_DIR."include/footer/phone.php", array(), array(
										"MODE" => "html",
										"NAME" => "Title",
										"TEMPLATE" => "include_area.php",
									)
								);?>
								<?$APPLICATION->IncludeFile(SITE_DIR."include/footer/email.php", array(), array(
										"MODE" => "html",
										"NAME" => "Title",
										"TEMPLATE" => "include_area.php",
									)
								);?>
								<?$APPLICATION->IncludeFile(SITE_DIR."include/footer/adress.php", array(), array(
										"MODE" => "html",
										"NAME" => "Title",
										"TEMPLATE" => "include_area.php",
									)
