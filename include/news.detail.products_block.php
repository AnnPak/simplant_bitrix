...
if($arRegion)
{
	...
	$GLOBALS['arrProductsFilter']['IBLOCK_ID'] = \Bitrix\Main\Config\Option::get("aspro.next", "CATALOG_IBLOCK_ID", "18");
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_ID" => \Bitrix\Main\Config\Option::get("aspro.next", "CATALOG_IBLOCK_ID", "18"),
