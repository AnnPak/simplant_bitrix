...
<?
$form_id = htmlspecialcharsbx(isset($_REQUEST["form_id"])) ? htmlspecialcharsbx($_REQUEST["form_id"]) : 1;
...
<?elseif(htmlspecialcharsbx(isset($_REQUEST['type'])) && $_REQUEST['type'] == 'auth'):?>
